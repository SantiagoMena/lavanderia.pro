...
class BusinessUpdateForm extends StatefulWidget {
   const BusinessUpdateForm({super.key, this.token});

  final String? token;

  @override
  State<BusinessUpdateForm> createState() => _BusinessUpdateFormState();
}

class _BusinessUpdateFormState extends State<BusinessUpdateForm> {
