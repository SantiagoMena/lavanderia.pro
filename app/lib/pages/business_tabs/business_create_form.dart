...
class BusinessCreateForm extends StatefulWidget {
   const BusinessCreateForm({super.key, this.token});

  final String? token;

  @override
  State<BusinessCreateForm> createState() => _BusinessCreateFormState();
}

class _BusinessCreateFormState extends State<BusinessCreateForm> {
