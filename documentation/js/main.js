(function($) {
	...
	*/
	...
	$('body').on('click', '#pageContent .imgmodal', function(){
		console.log('test');
		var imgSrc = $(this).attr('src');
		var wrapLayout = '<div class="imgmodal-wrap"><img src="'+imgSrc+'"></div>';
		$body.append(wrapLayout);
	});
	$('body').on('click', '.imgmodal-wrap', function(){
		$(this).remove();
	});
})(jQuery);